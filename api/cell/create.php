...
$stmt = $db->prepare('
    INSERT INTO cells (server_id, local_udid, user_id, cell_type, title, description, importance, content_json, custom_id, desktop_origin, scheduled_delete, scheduled_delete_at)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
');
$stmt->execute([
    $serverId,
